...
, gmp, mpfr, libmpc, gettext, which, flex
...
stdenv.mkDerivation ({
  ...
  src = fetchurl {
    url = "ftp://ftp.gwdg.de/pub/misc/gcc/snapshots/${version}/gcc-${version}.tar.bz2";
    sha256 = "1wzgshwfbgfbl35vqx9vg3px8bk4qz6ak1nh83d35q7cn54qz6c3";
  };
  ...
  nativeBuildInputs = [ texinfo which gettext flex ]
